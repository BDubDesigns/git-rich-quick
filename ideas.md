...
create a component for the items in the button box since it repeats styling. should also figure out how to make it look better, color the icons, and center the 2 items in each component on top of each other or left aligned for both so it doesnt look so crummy
